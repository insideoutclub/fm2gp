...
fn main() {
    ...
    println!(
        ...
        fmgp::distance_random_access(x1)
    );
    ...
    println!(
        ...
        fmgp::find_if(&mut x2, equal_3).unwrap()
    );
    println!(
    ...
    println!(
        ...
        fmgp::find_if_n(&mut l.iter(), 3, equal_3).0.unwrap()
    );
    ...
    println!(
        ...
        fmgp::partition_point(l.iter(), less_3).next().unwrap()
    );
    println!(
    ...
    println!(
        ...
        fmgp::partition_point_n(l.iter(), 3, less_3).next().unwrap()
    );
    println!(
    ...
    println!(
        ...
        fmgp::upper_bound(l.iter(), &&2).next().unwrap()
    );
    ...
    println!(
        ...
        fmgp::lower_bound(l.iter(), &&2).next().unwrap()
    );
}
